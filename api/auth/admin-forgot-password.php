...
try {
    ...
    $stmt = $db->prepare("SELECT id FROM users WHERE email = :email AND role = 'admin'");
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Admin Password Reset - ' . getenv('APP_NAME');
    $mail->Body    = '<p>Click the link below to reset your admin password (expires in 1 hour):</p>'
